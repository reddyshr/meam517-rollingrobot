!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!     File  sn05adwrp.f  --- user-function wrapper for  SNOPTA.
!     Version of sn05wrpa that defines userfg with system workspace.
!
!     s0fgA    s0fgA1
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      subroutine s0fgA
     &   ( iExit, modefg, snStat, getCon, getObj,
     ...
     &     nnObj, snStat, indJ(ne), locJ(nlocJ), iu(leniu), iw(leniw)
      double precision
...
!     ==================================================================
!     s0fgA  calls the user-written routine  userfg  to evaluate the
...
!     ------------------------------------------------------------------
     ...
     &           ne, nlocJ, locJ, indJ, gCon, rw, lenrw )
      ...
      !=================================================================
      if (snStat .eq. 1  .and.  iExit .eq. 0) then
         !--------------------------------------------------------------
