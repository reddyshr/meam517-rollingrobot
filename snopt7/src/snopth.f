!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!     File  snopth.f --- snOpt interface with Combined obj/constraints
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     nnObjU, nnJac, indJ(ne), hs(n+m), locJ(n+1), iu(leniu),
     &     iw(leniw)
      double precision
     &     sInf, Obj, objUAdd, Jcol(ne), bl(n+m), bu(n+m), x(n+m),
