/* ../snopt7/src/np02lib.f -- translated by f2c (version 20100827).
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* Subroutine */ int nptitle_(char *title, ftnlen title_len)
{
    /* Builtin functions */
...
/*     ================================================================== */
    s_copy(title, "N P O P T  7.4-1.2  (Feb 2015)", (ftnlen)30, (ftnlen)30);
	...
	integer *leniw, doublereal *rw, integer *lenrw)
{
    ...
    extern /* Subroutine */ int nptitle_(char *, ftnlen);
	...
	integer *iw, integer *leniw, doublereal *rw, integer *lenrw)
{
    ...
    static integer nnjac, nnobj, iobju, nncon, maxcw, nncol;
    ...
    static integer negcon, llencw, inform__, lleniw, mqnmod, lvlhes, nnobju, 
	    llenrw, liwest, nextcw;
    static char solver[6];
    extern /* Subroutine */ int snwrap_(integer *, char *, char *, char *, 
	    integer *, integer *, ftnlen, ftnlen, ftnlen);
...
/*     s8Defaults needs various problem dimensions in iw. */
    ...
    s8defaults_(&m, n, &nncon, &nnjac, &nnobju, &iobju, cw, &llencw, &iw[1], &
	...
	doublereal *rw, integer *lenrw, ftnlen buffer_len)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___61 = { 0, key, 0, "(i16)", 16, 1 };
	...
	doublereal *rw, integer *lenrw, ftnlen buffer_len)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___69 = { 0, key, 0, "(1p, e16.8)", 16, 1 };
