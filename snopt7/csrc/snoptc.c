/* ../snopt7/src/snoptc.f -- translated by f2c (version 20100827).
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* Subroutine */ int snoptc_(char *start, integer *m, integer *n, integer *
	nej, integer *nnames, integer *nncon, integer *nnobju, integer *nnjac,
	 integer *iobju, doublereal *objuadd, char *prob, U_fp userfun, 
...
/*     ------------------------------------------------------------------ */
    ...
    /* Function Body */
    snkerc_(start, m, n, nej, nnames, nncon, nnobju, nnjac, iobju, objuadd, 
	    prob, (U_fp)userfun, (U_fp)snlog_, (U_fp)snlog2_, (U_fp)sqlog_, (
	    U_fp)snstop_, &jcol[1], &indj[1], &locj[1], &bl[1], &bu[1], names 
	    + 8, &hs[1], &x[1], &pi[1], &rc[1], info, mincw, miniw, minrw, ns,
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* subroutine snOptc */
/* Subroutine */ int snkerc_(char *start, integer *m, integer *n, integer *
	nej, integer *nnames, integer *nncon, integer *nnobju, integer *nnjac,
	 integer *iobju, doublereal *objuadd, char *prob, U_fp userfun, U_fp 
	...
	ftnlen names_len, ftnlen cu_len, ftnlen cw_len)
{
    ...
    static integer minmax, inform__, mqnmod, lvlhes, letype;
...
/* eType(nb) definition of elastic vars */
	lgobj = iw[297];
/* gObj(nnObjU) = Objective gradient */
...
/*        Define the type of initial Hessian. */
	...
	s8solve_(info, solver, &starttype, (U_fp)s0fgc_, (U_fp)userfun, (U_fp)
		userfun, (U_fp)s8hxnp_, (U_fp)snlog, (U_fp)snlog2, (U_fp)
