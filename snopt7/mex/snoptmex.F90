...
subroutine snmxSolve (nlhs, plhs, nrhs, prhs)
  ...
  if (freebie) then
     if ( n > maxCol) call mexErrMsgIdAndTxt('SNOPT:InputArgs','Maximum column size of 300 exceeded')
     if (nF > maxRow) call mexErrMsgIdAndTxt('SNOPT:InputArgs','Maximum row size of 300 exceeded')
  end if
