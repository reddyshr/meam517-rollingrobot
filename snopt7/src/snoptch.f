!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!     File  snoptch.f --- snOpt interface with Combined obj/constraints
!                         and user-defined Hessian.
!
!     snOptCH   snKerCH
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      subroutine snOptCH
     &   ( Start, m, n, neJ, neH, nNames,
     &     nnCon, nnObjU, nnJac, nnH,
     &     iObjU, objUAdd, Prob,
     &     userfun,
     &     Jcol, indJ, locJ,
     &     Hcol, indH, locH,
     ...
     &     mincw, miniw, minrw, m, n, neJ, neH, nNames, nS, nInf,
     &     nnCon, nnH, nnJac, nnObjU, indH(neH), indJ(neJ), hs(n+m),
     &     locH(nnH+1), locJ(n+1), iu(leniu), iw(leniw)
      double precision
     &     sInf, Obj, objUAdd, Hcol(neH), Jcol(neJ), bl(n+m), bu(n+m),
...
!     ------------------------------------------------------------------
!     snOptCH  is a Fortran subroutine for constrained nonlinear
...
!             Must have locJ(1) = 1 and locJ(n+1) = neJ+1.
!
...
!     19 Sep 2014: User-defined Hessian added.
!     ==================================================================
      external
...
!     ------------------------------------------------------------------
     ...
     &     Jcol, indJ, locJ,
     &     Hcol, indH, locH,
     &     bl, bu, Names, hs, x, pi, rc,
     &     INFO, mincw, miniw, minrw,
     &     nS, nInf, sInf, Obj,
     &     cu, lencu, iu, leniu, ru, lenru,
     &     cw, lencw, iw, leniw, rw, lenrw )

      end ! subroutine snOptCH
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     none
      external
     &     userfun, userHv, snLog, snLog2, sqLog, snSTOP
      integer
     &     INFO, iObjU, lencu, leniu, lenru, lencw, leniw, lenrw,
     &     mincw, miniw, minrw, m, n, neJ, neH, nNames, nS, nInf,
     &     nnCon, nnH, nnJac, nnObjU, indH(neH), indJ(neJ), hs(n+m),
     &     locJ(n+1), locH(nnH+1), iu(leniu), iw(leniw)
      double precision
     &     sInf, Obj, objUAdd, Hcol(neH), Jcol(neJ),
     &     bl(n+m), bu(n+m), x(n+m), pi(m),
...
!     ==================================================================
     ...
     &     nnObj, nlocG, nlocH, nlocJ, nMajor, nnH0, nrhs, nrhs0, nx0,
     &     startType, stickyOp
      double precision
     &     fObj, objAdd, objTrue, sInfE, rhs(1), x0(1)
      external
     &     s0fgCH, s8HxLP, s8HxNP, s8HxQP
!     ------------------------------------------------------------------
