...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     d, ddiv
      ...
      if (nS .eq. 0) then
         ...
         if (nS .eq. 1) then
            condH = ddiv( one, dRmin**2, OverFlow )
            ...
            condH  = ddiv( dRmax**2, dRmin**2, OverFlow )
         end if
      end if
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      subroutine s6Rcol
     &   ( job, jR, maxR, nR, lenR, R, v, lRdiag )

      implicit
     &     none
      integer
     &     job, jR, maxR, nR, lenR, lRdiag
      double precision
     &     R(lenR), v(nR)
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      subroutine s6Rfix
     &   ( maxR, nS, lenR, R, dRmax, dRmin, condH, Hcondbnd )
     ...
     &     maxR, nS, lenR
      double precision
     &     dRmax, dRmin, condH, Hcondbnd, R(lenR)
     ...
     &     d
      ...
      nR     = min( nS, maxR )
      dRmin  = max( dRmin, dRmax/Hcondbnd )
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     incR, j, k, l, ldiag, nR, nzero
      double precision
     &     diag, dRmax, dRmin, ddiv
      !-----------------------------------------------------------------
      integer            LOAD,           MODIFY
      parameter         (LOAD  = 1,      MODIFY = 2)
      ...
      if (nR .eq.  0) then
         ...
         condH = ddiv( dRmax, dRmin, OverFlow )
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     told, (vnorm*tolz) )
      ...
      end ! subroutine s6Rswap

!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

      subroutine s6Rupdate
     &   ( updateType, maxR, lenR, m, n, nBS, nnL, nS,
     &     U0scal, rdxHdx, neA, nlocA, locA, indA, Acol,
     &     kBS, v, Hdx, R, w, y, y1,
     &     iw, leniw, rw, lenrw )
     ...
     &     none
      integer
     &     updateType, maxR, lenR, m, n, nBS,
     &     neA, nlocA, nnL, nS, leniw, lenrw,
     &     indA(neA), locA(nlocA), kBS(nBS), iw(leniw)
      double precision
     &     rdxHdx, U0scal, Acol(neA), R(lenR), v(nnL),
