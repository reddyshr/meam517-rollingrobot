...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     iGfun(lenG), jGvar(lenG), iw(leniw), iu(leniu)
      double precision
     &     eGmax, F(nF), F1(nF),
     &     G(lenG), G1(lenG), ru(lenru), rw(lenrw), w(nF), w1(nF),
     &     x(n), x1(n), y(n)
      character
     &     cu(lencu)*8
...
!     07 Oct 2015: Dimensions of w and w1 defined correctly.
!     07 Oct 2015: Elem initialized correctly for each column.
!     ==================================================================
      external
     &     idamax, dnormi
      character
...
!     27 Jun 2016: NonlinearCon assignment now based on nnCon.
!     ==================================================================
      external
