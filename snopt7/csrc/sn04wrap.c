/* ./src/sn04wrap.f -- translated by f2c (version 20100827).
	...
	*string2, ftnlen solver_len, ftnlen string_len, ftnlen string2_len)
{
    ...
    static integer indc[15] = { 0,7,14,17,22,28,34,38,43,48,52,60,64,66,71 };
    static char c__[80*75] = "finished successfully                         "
	    ...
	    "                                     " "infeasible linear constr"
	    "aints                                                   " "infea"
	    "sible linear equality constraints                               "
	    "           " "nonlinear infeasibilities minimized               "
	    "                              " "linear infeasibilities minimize"
	    "d                                                " "infeasible l"
	    "inear constraints in QP subproblem                              "
	    ...
	    "t the first feasible point                                  " 
	    "undefined function at the initial point                        "
	    "                 " "unable to proceed into undefined region     "
	    "                                    " "user requested terminatio"
	    "n                                                      " "termin"
	    "ated during function evaluation                                 "
	    "          " "terminated during constraint evaluation            "
	    "                             " "terminated during objective eval"
	    "uation                                          " "terminated fr"
	    "om monitor routine                                              "
	    "   " "insufficient storage allocated                            "
	    "                      " "work arrays must have at least 500 elem"
	    "ents                                     " "not enough character"
	    " storage                                                    " 
	    "not enough integer storage                                     "
	    "                 " "not enough real storage                     "
	    "                                    " "input arguments out of ra"
	    "nge                                                    " "invali"
	    "d input argument                                                "
	    ...
	    "                 " "user-supplied derivatives appear to be corre"
	    "ct                                  " "no derivatives were check"
	    "ed                                                     " "some S"
	    "PECS keywords were not recognized                               "
	    "          " "errors while processing MPS data                   "
	    "                             " "no MPS file specified           "
	    "                                                " "problem-size "
	    "estimates too small                                             "
	    "   " "fatal error in the MPS file                               "
	    "                      " "errors while estimating Jacobian struct"
	    "ure                                      " "cannot find Jacobian"
	    " structure at given point                                   " 
	    "fatal errors while reading the SPECS                           "
	    "                 " "no SPECS file (iSpecs le 0 or iSpecs gt 99) "
	    "                                    " "End-of-file while looking"
	    " for a BEGIN                                           " "End-of"
	    "-file while reading SPECS file                                  "
	    "          " "ENDRUN found before any valid SPECS                "
	    "                             " "system error                    "
	    "                                                " "wrong no of b"
	    "asic variables                                                  "
	    "   " "error in basis package                                    "
	    "                      " "Problem dimensions are too large       "
	    "                                         ";
