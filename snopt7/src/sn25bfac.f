...
!     28 Sep 2015: inform = 10 checked on exit from s2BLU.
!     =================================================================
      character
     &     str*72
      logical
...
!           ------------------------------------------------------------
     ...
     &           iy, iy1, y, iw, leniw, rw, lenrw )
            ...
            if (     inform .ge. 10) then
               iExit = 142      ! This should never happen
               go to 400
            else if (inform .ge.  7) then
