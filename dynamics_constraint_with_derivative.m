function [h_i,dH_i] = dynamics_constraint_with_derivative(x_i, u_i, x_ip1, u_ip1, dt, M, I1, I2, I3, r, l, g)
...
%   @output dH_i: jacobian of h_i evaluated at(x_i, u_i, x_ip1, u_ip1).
  ...
  h_i = dynamics_constraint(x_i, u_i, x_ip1, u_ip1, dt, M, I1, I2, I3, r, l, g);
