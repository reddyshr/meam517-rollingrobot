function [h,dH] = dynamics_constraints(z, N, nx, nu, dt, M, I1, I2, I3, r, l, g)
...
for i=1:(N-1)
   ...
   [h_i, dH_i] = dynamics_constraint_with_derivative( z(x_i_inds), z(u_i_inds), z(x_ip1_inds), z(u_ip1_inds), dt, M, I1, I2, I3, r, l, g);
