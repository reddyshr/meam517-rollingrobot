...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     iu(leniu), iw(leniw)
      double precision
     &     objAdd, sInf, obj, Acol(neA), bl(n+m), bu(n+m), cObj(*),
...
!     ==================================================================
     ...
     &     gotR, PrtMem
      integer
     &     Errors, lenR, lenx0, liwEst, lrwEst, lkx, lvlStart,
     &     maxcw, maxiw, maxrw, maxR, maxS, mProb, nb,
     &     nextcw, nextiw, nextrw, nnH0, nInfE, ngQP,
     &     ngObj0, ngObj, nkx, nlocA, nnCon, nnJac, nnH,
     &     nrhs0, nrhs, nx0, inform, startType, stickyOp, Useriw(130)
      integer
     &     neH, nlocH, indH(1), locH(1)
      double precision
     &     Hcol(1)
      double precision
     &     objQP, objTrue, sInfE, rhs(1), x0(1), Userrw(130)
      external
     &     sqHx
!     ------------------------------------------------------------------
...
!     Check the input arguments.
      ...
      call s3chkArgsQ
     &   ( inform, Start, m, n, neA, nNames, nS,
     &     lencObj, iObj, ncolH,
...
!     ------------------------------------------------------------------
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      call s3printQ
     &   ( m, n, lencObj, ncolH, startType, iw, leniw, rw, lenrw )
...
!     Load iw with various problem dimensions.
      ...
      iw( 17) = neA   ! copy of the number of nonzeros in Jcol
